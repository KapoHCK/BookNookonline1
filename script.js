document.addEventListener('DOMContentLoaded', function() {
    ...
    const allBooksData = {
       'rogor-vimushaot-sakutar-tavze': {
        ...
        // --- აქ დაამატეთ თქვენი ახალი წიგნი (ან წიგნები)! ---
        // დაამატეთ აქ ახალი წიგნის ID, მაგალითად: 'chemi-axali-cigni'
        'chemi-axali-cigni': { // აუცილებლად შეცვალეთ ეს ID თქვენი წიგნის უნიკალური ID-ით
            id: 'chemi-axali-cigni',
            title: 'ჩემი ახალი წიგნი', // წიგნის სათაური
            author: 'თქვენი სახელი', // წიგნის ავტორი
            cover: 'images/chemi_axali_cignis_yda.png', // გზა თქვენი წიგნის ყდის სურათამდე
            price: '25 ₾', // წიგნის ფასი
            description: `
                <p>აქ ჩაწერეთ თქვენი ახალი წიგნის მოკლე აღწერა. ეს გამოჩნდება "წიგნები" განყოფილებაში.</p>
                <p>შეგიძლიათ დაამატოთ რამდენიმე აბზაცი აღწერისთვის.</p>
            `,
            pages: [
                `<h3>შესავალი ახალ წიგნში</h3><p>მოგესალმებით ჩემს ახალ შემოქმედებაში! იმედი მაქვს, მოგეწონებათ ეს ამონარიდი.</p>`,
                `<h3>თავი პირველი: დასაწყისი</h3><p>აქ ჩაწერეთ თქვენი წიგნის პირველი თავის ამონარიდი. ეს არის პირველი გვერდის ტექსტი.</p>`,
                // შეგიძლიათ დაამატოთ მეტი გვერდი აქ, თუ გსურთ მეტი ამონარიდი მოდალში:
                // `<h3>თავი პირველი: გვერდი 2</h3><p>ტექსტი მეორე გვერდიდან...</p>`,
                // `<h3>ბოლო გვერდი</h3><p>მოკლე დასკვნა ან ფრაგმენტი...</p>`
            ]
        }
        // თუ გსურთ კიდევ ერთი წიგნის დამატება, აქ ისევ დაამატეთ მძიმე (",") და შემდეგ ახალი ობიექტი
    };
